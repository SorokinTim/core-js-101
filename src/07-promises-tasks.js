...
function willYouMarryMe(isPositiveAnswer) {
  return new Promise((resolve, reject) => (typeof isPositiveAnswer !== 'boolean' ? reject(new Error('Wrong parameter is passed! Ask her again.')) : resolve(isPositiveAnswer ? 'Hooray!!! She said "Yes"!' : 'Oh no, she said "No".')));
}
